...
description: 'Lista wymagań stawianych aplikacji dostarczającej informacji o 
dawkowaniu leków. MoSCoW dla DDS.'
keywords: 'daj się poznać 2017, konkurs programistyczny, aplikacja konkursowa,
drug dose framework, aplikacja mobilna, pas pediatryczny, dawkowanie leków, analiza wymagań,
metoda moscow, must should could wont'
tags:
- DSP2017
- C++
- DDS
...
[2]: {{ site.url }}/2016/03/01/dam-sie-poznac.html
[3]: {{ site.url }}/2017/03/14/pistacja.html
[4]: {{ site.url }}/2016/03/12/format-opisu-lekow-w-ddf.html
